...
```
.package(url: "https://github.com/reclaimprotocol/reclaim-inapp-ios-sdk.git", from: "0.39.0")
```
...
1. Make sure you have the latest version of the Reclaim InApp SDK. Currently the latest version is `0.39.0`. 
